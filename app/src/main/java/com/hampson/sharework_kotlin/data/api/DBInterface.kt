...
interface DBInterface {
    ...
    // job
    @GET("api/v1/jobs")
    fun getJob(@Query("job_id") job_id: String, @Query("page") page: Int, @Query("size") size: Int): Single<Response>
    ...
    fun createLocationFavorites(@Body location: LocationFavorites): Single<Response>
