...
class JobInMapRepository (private val apiService : JobDBInterface) {
    ...
    fun fetchMapUpdate (compositeDisposable: CompositeDisposable, northeast_lat: Double, northeast_lng: Double, southwest_lat: Double, southwest_lng: Double) : MutableLiveData<List<Job>> {
        jobInMapDataSource = JobInMapDataSource(apiService, compositeDisposable)
        jobInMapDataSource.fetchJobInMap(northeast_lat, northeast_lng, southwest_lat, southwest_lng)
