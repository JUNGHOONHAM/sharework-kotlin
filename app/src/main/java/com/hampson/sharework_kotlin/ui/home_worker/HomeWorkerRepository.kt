...
class HomeWorkerRepository (private val apiService : DBInterface) {
    ...
    fun getjobList (compositeDisposable: CompositeDisposable, northeast_lat: Double, northeast_lng: Double, southwest_lat: Double, southwest_lng: Double) : MutableLiveData<List<Job>> {
