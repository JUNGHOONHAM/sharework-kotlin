...
class ClusterJobInMapViewModel (private val jobRepository: JobInMapRepository, northeast_lat: Double, northeast_lng: Double, southwest_lat: Double, southwest_lng: Double) : ViewModel() {
    ...
    private val searchPosition: MutableLiveData<LatLng> = MutableLiveData()
    ...
    fun updateMap(northeast_lat: Double, northeast_lng: Double, southwest_lat: Double, southwest_lng: Double): MutableLiveData<List<Job>> {
    ...
    private fun getAddressInfo(addresses: List<Address>) {
        ...
        searchPosition.postValue(latLng)
    }
}